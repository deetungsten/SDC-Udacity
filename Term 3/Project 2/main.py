...
'''
#THIS IS TAKEN FROM TERM 1- LESSON 8
...
def train_nn(sess, epochs, batch_size, get_batches_fn, train_op, cross_entropy_loss, input_image,
    ...
    """
    # TODO: Implement function
    #PART OF CODE TAKEN FROM TERM 1- LESSON 8
    ...
    for epoch_i in range(epochs):
        for image, label in get_batches_fn(batch_size):
            ...
            train_feed_dict = {
                ...
                learning_rate: 0.001,
                keep_prob: 0.5}
            _,current_cost = sess.run([train_op, cross_entropy_loss], feed_dict=train_feed_dict)
